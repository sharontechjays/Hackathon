...
object Utility {
    ...
    fun loadImage(aURL: String?, image: ImageView) {
        try {
            if (aURL.isNullOrEmpty())
                ...
                loadFitImage(aURL, image, R.drawable.ic_user_placeholder)
        } catch (e: Exception) {
            e.printStackTrace()
        }
    }
     ...
     * Load images
     */
    fun loadImage(aURL: String?, image: ImageView, noCrop: Boolean) {
        try {
            if (aURL.isNullOrEmpty())
                image.setImageResource(R.drawable.ic_user_placeholder)
            else {
                if (noCrop)
                    loadImage(aURL, image, R.drawable.ic_user_placeholder)
                else loadFitImage(aURL, image, R.drawable.ic_user_placeholder)
            }
        } catch (e: Exception) {
            e.printStackTrace()
        }
     ...
     * Load images
     */
    private fun loadFitImage(aURL: String?, image: ImageView, placeHolder: Int) {
        try {
            if (aURL.isNullOrEmpty()) {
                image.setImageResource(placeHolder)
            } else {
